...
public class BussinessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.business_rv);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            main = new MainAdapter(BussinessActivity.this, modelnya, new MainAdapter.Callback() {
                                @Override
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(BussinessActivity.this);
